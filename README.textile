...
* No lame out-of-the-box view/javascripts/images that you probably won't use in the final product anyway. That should be an extension to the plugin.
...
* @recent(<datetime_or_size>)@ - pick reviews created since @<by_earliest_datetime>@.
...
* @with_comment@ - pick reviews with comments, i.e. not nile.
...
* Make @review!@ accept any additional attributes to update except for the ones used by IsReviewable, i.e. ~100% customizable review attributes.
